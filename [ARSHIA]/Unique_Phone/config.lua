...
Config.Language = 'en'
-- No longer used by the phone camera: it now saves photos as base64
-- directly (via screenshot-basic's requestScreenshot) instead of
-- uploading anywhere, so nothing needs to be configured here for photos
-- to work. Left in place in case something else in the future wants it.
