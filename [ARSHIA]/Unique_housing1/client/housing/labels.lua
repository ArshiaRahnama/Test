local labels = {
  ['en'] = {
    ...
    ['InteractDrawText']  = "["..HousingConfig.TextColors[HousingConfig.MarkerSelection].."E~s~] ",
    ['InteractHelpText']  = "~INPUT_PICKUP~ ",

    ['AcceptDrawText']    = "["..HousingConfig.TextColors[HousingConfig.MarkerSelection].."G~s~] ",
    ['AcceptHelpText']    = "~INPUT_DETONATE~ ",

    ['FurniDrawText']     = "["..HousingConfig.TextColors[HousingConfig.MarkerSelection].."F~s~] ",
    ['CancelDrawText']    = "["..HousingConfig.TextColors[HousingConfig.MarkerSelection].."F~s~] ",
...
Labels = labels[HousingConfig.Locale]
