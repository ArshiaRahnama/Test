...
-- (هیچ‌جا ESX.* صدا نمی‌زنه)، پس صفر ریسک سازگاری داشت.
-- کانفیگ (SpeedUnit/HudPosition) مستقیم همینجاست، به هیچ فایل دیگه‌ای
-- وابسته نیست.

local SpeedUnit   = 'kmh'   -- 'kmh' or 'mph'
local HudPosition = 'center' -- 'right' / 'left' / 'center' (پایین وسط)

local isMetric = SpeedUnit == 'kmh'
local hudPosition = HudPosition
