...
ReportLan.cantReportSelf    = "نمی‌تونی خودت رو گزارش بدی."
ReportLan.noteSaved         = "یادداشت ذخیره شد."
ReportLan.banAndClose       = "ریپورت #%s با بن بسته شد. (%s)"
ReportLan.targetOffline     = "بازیکنِ هدف آنلاین نیست - برای بن از /aban وقتی وصل شد استفاده کن."
ReportLan.streakBonus       = "🔥 %d روز پشت‌سرهم بدون امتیازِ زیر ۳! +%d XP بونس."
