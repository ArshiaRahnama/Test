...
-- PunishConfig.AllowedJobs below. Mirrors Unique_AdminMenu's own
-- PunishConfig.MinPermissionLevel gate.
PunishConfig.AdminPermissionLevel = 2

PunishConfig.AdminJail = {
	unjail = vec(212.92, -845.81, 30.38)
}

PunishConfig.AllowedJobs = {
