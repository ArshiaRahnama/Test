...
function resetNormalCamera()
  ...
  sp = 0
	...
	NetworkSetInSpectatorMode(false, 0)
  DetachEntity(playerPed, true, true)
  TriggerServerEvent('Unique_AdminPanel:AntiCheatExempt', 5000, { teleport = true, speed = true, invisibility = true })
...
function teleportToPlayer(serverId)
  ...
  TriggerServerEvent('Unique_AdminPanel:AntiCheatExempt', 5000, { teleport = true, speed = true })
