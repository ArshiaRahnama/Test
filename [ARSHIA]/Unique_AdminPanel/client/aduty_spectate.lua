...
function AdutyPolar3DToWorld3D(entityPosition, radius, polarAngleDeg, azimuthAngleDeg)
...
function AdutyResetNormalCamera()
...
AdutyResetNormalCamera()
end)

RegisterNetEvent('esx_spectate:AdutySpectate')
AddEventHandler('esx_spectate:AdutySpectate', function()
...
RegisterNUICallback('kick', function(data, cb)
	...
	TriggerEvent('esx_spectate:AdutySpectate')
end)
...
Citizen.CreateThread(function()
  	...
  	while true do
		...
		if InSpectatorMode then
			...
			local nextCamLocation = AdutyPolar3DToWorld3D(coords, radius, polarAngleDeg, azimuthAngleDeg)
