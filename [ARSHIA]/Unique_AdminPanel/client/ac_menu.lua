...
-- FIX: "giveAllWeapon" ("All Weapons") admin-panel weapon spawn removed by
-- request. "Clear Weapons" (below/elsewhere) is kept since it's a cleanup
-- tool, not a way to hand out guns.
...
function handelSpectate(player, ped)
    Citizen.CreateThread(function()
        ...
        while InSpectatorMode do
            ...
            local nextCamLocation = UACPolar3DToWorld3D(coords, radius, polarAngleDeg, azimuthAngleDeg)
...
function UACPolar3DToWorld3D(entityPosition, radius, polarAngleDeg, azimuthAngleDeg)
