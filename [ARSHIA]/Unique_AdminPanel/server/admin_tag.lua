...
local function BroadcastAdminTags()
    ...
    TriggerClientEvent('Unique_AdminPanel:SyncAdminTags', -1, tags)
end

RegisterServerEvent('Unique_AdminPanel:UpdateAdminTag')
AddEventHandler('Unique_AdminPanel:UpdateAdminTag', function()
...
-- going through Unique_AdminPanel:UpdateAdminTag (e.g. esx_aduty console command).
...
AddEventHandler('esx:playerLoaded', function(playerId)
    Citizen.SetTimeout(500, function()
        TriggerClientEvent('Unique_AdminPanel:SyncAdminTags', playerId, (function()
            local tags = {}
            local players = ESX.GetPlayers()
            for i = 1, #players do
