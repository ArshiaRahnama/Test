...
-- Unique_AdminPanel:SetButtonPerm changes a value (see server/settings.lua).
ButtonPermsCache = {}
...
RegisterServerEvent('Unique_AdminPanel:RequestToggle')
AddEventHandler('Unique_AdminPanel:RequestToggle', function(feature)
    local source = source
