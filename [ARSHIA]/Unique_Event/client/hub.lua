--[[
    ...
    Opens /event, fetches data from the server, forwards hub button clicks, and drives the
...
if Config.Hub.Key then RegisterKeyMapping(Config.Hub.Command, 'Unique Event: open /event menu', 'keyboard', Config.Hub.Key) end
