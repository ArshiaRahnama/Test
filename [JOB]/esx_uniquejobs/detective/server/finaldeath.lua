--[[
    ...
    Config_detective.finalDeath.bleedoutMs has passed, they were never revived in time —
...
AddEventHandler('kq_detective:savePlayerInfo', function()
    ...
    SetTimeout(Config_detective.finalDeath.bleedoutMs, function()
        ...
        for _, playerId in ipairs(GetPlayers()) do
            ...
            if xTarget and Contains(Config_detective.finalDeath.notifyJobs, xTarget.job.name) then
...
--[[
    SOLO TEST COMMAND — only exists while Config_detective.debug = true. Broadcasts the
