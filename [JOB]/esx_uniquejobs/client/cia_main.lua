...
-- (locales/cia_en.lua -> Locales['en_cia']) instead of the old shared global
...
local function _U(str, ...)
	local tbl = Locales['en_cia']
	local v = tbl and tbl[str]

	if ( v == nil ) then
		return "Error [en_cia][" .. tostring(str) .. "] Be Developer Elam Konid"
	end
