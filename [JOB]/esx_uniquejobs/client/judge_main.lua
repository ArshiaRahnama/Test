...
-- Vehicles added live via esx_society's /addcarjob command (job = judge) get merged
...
local function removeInjected_judge(list, injected)
...
Citizen.CreateThread(function()
	...
	local function mergeCustomVehicles()
		ESX.TriggerServerCallback('esx_society:getCustomVehicles', function(list)
			removeInjected_judge(Config_judge.AuthorizedVehicles.Shared, InjectedVehicleEntries)
			removeInjected_judge(Config_judge.AuthorizedVehicles.Sharedheli, InjectedHeliEntries)
			InjectedVehicleEntries = {}
			InjectedHeliEntries    = {}
			CustomVehicleLiveries  = {}

			local custom = list and list['judge']
			...
			for _, v in ipairs(custom) do
				...
				if v.is_heli == 1 then
					table.insert(Config_judge.AuthorizedVehicles.Sharedheli, entry)
					table.insert(InjectedHeliEntries, entry)
				else
					table.insert(Config_judge.AuthorizedVehicles.Shared, entry)
...
Citizen.CreateThread(function()
	...
	for k,v in pairs(Config_judge.judgeStations) do
		...
		AddTextComponentString('Judge Station')
