...
-- (Locales['en_ambulance']) instead of the old shared global Locales['en'] table
...
local function _U(str, ...)
	local tbl = Locales['en_ambulance']
	local v = tbl and tbl[str]

	if ( v == nil ) then
		return "Error [en_ambulance][" .. tostring(str) .. "] Be Developer Elam Konid"
	end
