(function () {
	...
	const resourceName = (typeof GetParentResourceName === 'function') ? GetParentResourceName() : 'esx_boat';
	...
	const ICON = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M3 15h18l-2 3a2 2 0 0 1-1.7 1H6.7A2 2 0 0 1 5 18z"/><path d="M6 15V7l6-3 6 3v8"/><path d="M12 4v11"/></svg>';
	...
	function selectVehicle(v) {
		...
		postNUI('getStats', { model: v.model }).then(stats => {
			...
			el.statSpeed.style.width = Math.min(100, (stats.topSpeed / 140) * 100) + '%';
