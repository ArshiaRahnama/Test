...
function OpenPropertyInventoryMenu(property, owner)
	...
	-- lc-inventory's stash export (added specifically to support this kind
	-- of call - see server/apps/system/stash.lua + client/apps/system/stash.lua
	-- in lc-inventory) does the equivalent, just with maxWeight/slot/label
	...
	-- unconfigured lc-inventory stash.
	exports['lc-inventory']:stash('property_' .. owner, nil, nil, property and property.label or ('Property ' .. owner))
end
