...
RegisterCommand("SitAnyWhere", function()
    ...
    local AnimationsQuick = SitConfig.SitAnyWhereAnims
    local Cur_Anim = 1
            ...
            if IsDisabledControlJustReleased(0, 24) then
                ...
                if not SkipSeat then
                    ...
                    for i = 1, #AnimationsQuick do
                        ...
                        if not CurrentAnim_Key and CurrentDict_Key and SitConfig.AnimDescriptions[CurrentDict_Key] then
                            AnimationsQuick[i].description = SitConfig.AnimDescriptions[CurrentDict_Key].description
                            AnimationsQuick[i].title = SitConfig.AnimDescriptions[CurrentDict_Key].title
                        elseif CurrentDict_Key and SitConfig.AnimDescriptions[CurrentDict_Key] and CurrentAnim_Key and SitConfig.AnimDescriptions[CurrentDict_Key][CurrentAnim_Key] then
                            AnimationsQuick[i].description = SitConfig.AnimDescriptions[CurrentDict_Key][CurrentAnim_Key].description
                            AnimationsQuick[i].title = SitConfig.AnimDescriptions[CurrentDict_Key][CurrentAnim_Key].title
                        end
