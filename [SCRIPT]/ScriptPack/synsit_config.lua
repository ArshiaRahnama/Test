...
SitConfig = {}
SitConfig.TargetSytem = 'OX'
SitConfig.SmoothCancelSit = 32
SitConfig.QuickCancelSit = 58
SitConfig.OpenmenuWhileSitting = 203
SitConfig.StartChairCamera = 23
SitConfig.AllowChairCamera = true

SitConfig.AddHelpText = true
SitConfig.WhileSittingHelpText = "[W] - Stand Up    \n     [F] - Change camera   \n     [SPACEBAR] - Menu"
SitConfig.WhileSittinginfoFunction = function() lib.showTextUI(SitConfig.WhileSittingHelpText,{icon = 'fa-solid fa-chair'}) Citizen.SetTimeout(5000, function() if SitConfig.WhileSittinginfoFunction_IsOpenCheck() then SitConfig.WhileSittinginfoFunctionCancel() end end) end
SitConfig.WhileSittinginfoFunctionCancel =  function() lib.hideTextUI() end
SitConfig.WhileSittinginfoFunction_IsOpenCheck =  function() local isOpen, text = lib.isTextUIOpen() return isOpen, text  end

SitConfig.OxContextMenuTitle = "Seat Animations "
SitConfig.OxContextName = 'Sit Position '
SitConfig.OxContextLabel = 'Seating Options '
SitConfig.OxTargetLabel = 'Seating Options '

SitConfig.AllowHeadingChange = true
SitConfig.Debug = false

SitConfig.DebugMarkerColor = vector4(150, 150, 200, 100)

SitConfig.AnimDescriptions = {
