...
-- FontAwesome icons instead of the broken esx_inventory image paths.
...
-- icons instead of the broken esx_inventory image paths.
-- ============================================================
-- The old list pointed every entry at an `image` inside esx_inventory's
-- asset folder (nui://esx_inventory/...) that doesn't actually contain
